            ...
            <tbody>
                @forelse($users as $user)
                    @php
                        ...
                        $roleClass = in_array($user->role, ['admin', 'registrar', 'training_manager', 'trainer', 'trainee', 'participant']) ? $user->role : 'trainee';
                        $roleLabel = $user->role === 'trainer' ? 'coach' : ($user->role === 'training_manager' ? 'training manager' : $user->role);
