...
<div class="dashboard-container">
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-menu" style="list-style:none;padding:0;margin:0">
      ...
      <li class="nav-item" style="border-bottom:1px solid rgba(255,255,255,0.1)"><a href="{{ route('courses.create') }}" class="nav-link {{ request()->routeIs('trainer.courses.create') || request()->routeIs('courses.create') ? 'active' : '' }}" style="display:flex;align-items:center;padding:15px 25px;color:rgba(255,255,255,0.9);text-decoration:none"><i class="fas fa-plus-circle nav-icon" style="width:25px;text-align:center;margin-right:15px"></i><span class="nav-text">Create Course</span></a></li>
      @endif
