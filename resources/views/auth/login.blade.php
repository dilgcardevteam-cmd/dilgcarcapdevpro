...
<div class="container {{ (isset($action) && $action == 'login' && !old('name')) ? 'right-panel-active' : '' }}" id="container">
    ...
    <div class="form-container sign-up-container" style="position: relative;">
        <a href="{{ url('/') }}" style="position: absolute; top: 12px; right: 12px; text-decoration: none; color: #1a1a1aff; font-weight: 500; font-size: 18px; display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; transition: all 0.3s ease; z-index: 10; margin-right: 15px;" title="Back to Home">
