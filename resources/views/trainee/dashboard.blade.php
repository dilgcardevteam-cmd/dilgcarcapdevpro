            ...
            if (isDILGMode) {
                ...
                if (IS_OFFICE(myRole, 'central')) {
                    ...
                    provinceSelect.addEventListener('change', function(){
                        ...
                        const cityLabel = citySelect.closest('.form-group')?.querySelector('label'); if (cityLabel) cityLabel.textContent = (cat==='Bureau' ? 'Bureau' : 'Service');
                        ...
                        // keep disabled state consistent with edit mode toggle elsewhere
                    });
                    if (selectedProvince) {
                    ...
                    // Show Region only in second slot
                    const provLabel = provinceSelect.closest('.form-group')?.querySelector('label'); if (provLabel) provLabel.textContent = 'Region';
                    [citySelect, barangaySelect].forEach(s=>{ const g=s.closest('.form-group'); if (g) g.style.display='none'; });
                    // Load regions into provinceSelect
